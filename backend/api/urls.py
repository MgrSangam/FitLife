...
router.register(r'subscriptions', SubscriptionViewSet, basename='subscription')  # Updated to SubscriptionViewSet

# You no longer need a separate URL for create subscription as it's handled by the SubscriptionViewSet
